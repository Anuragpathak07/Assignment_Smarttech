  ...
  const MarkdownContent = ({ content }: { content: string }) => (
    <ReactMarkdown
      components={{
        ...
        strong: ({ ...props }) => <span className="font-semibold text-indigo-900" {...props} />,
        ...
        h1: ({ ...props }) => <h3 className="font-bold text-indigo-900 text-lg mt-3 mb-2" {...props} />,
        h2: ({ ...props }) => <h3 className="font-semibold text-indigo-900 text-base mt-3 mb-2" {...props} />,
        h3: ({ ...props }) => <h3 className="font-semibold text-indigo-900 text-sm mt-2 mb-1" {...props} />,
      }}
    >
      {content}
    </ReactMarkdown>
      ...
      <CardContent className="pt-6">
        ...
        {!loading && agentState === 'done' && (
          <motion.div
            ...
            className="bg-white rounded-xl border border-indigo-100 shadow-sm p-5 min-h-[200px] max-h-[500px] overflow-y-auto pr-2"
          >
            ...
            {selectedAgent === 'vitals' && details?.vitals && (
              <div className="prose prose-sm max-w-none">
                ...
                <div className="text-gray-700 bg-red-50/50 p-4 rounded-lg border border-red-100">
                  <MarkdownContent content={details.vitals} />
                </div>
              </div>
            )}
            ...
            {selectedAgent === 'labs' && details?.labs && (
              <div className="prose prose-sm max-w-none">
                ...
                <div className="text-gray-700 bg-blue-50/50 p-4 rounded-lg border border-blue-100">
                  <MarkdownContent content={details.labs} />
                </div>
              </div>
            )}
            ...
            {selectedAgent === 'risks' && details?.risks && (
              <div className="prose prose-sm max-w-none">
                ...
                <div className="text-gray-700 bg-purple-50/50 p-4 rounded-lg border border-purple-100">
                  <MarkdownContent content={details.risks} />
                </div>
              </div>
            )}
          </motion.div>
